...
public class AliPayTest {
     ...
     * <p>
     *
     * @see <a href="https://doc.open.alipay.com/docs/doc.htm?treeId=291&articleId=106097&docType=1">工具地址</a>
     */
    ...
    public static String generateOrderStr() {
        return generateOrderStr(TEST_APPID, TEST_RSA2_PRIVATE);
    }
